    ...
    private LayoutInflater mInflater;
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            try {
                ...
                view.findViewById(R.id.errorOverlay).setVisibility(View.GONE);

                // Hauptgerichte
                if(typeCounter(1,position)>0) {
